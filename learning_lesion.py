...
def generate_slice_randi(num, nout=3, DIR_DATA=None, SLIDE=False):
    ...
    if SLIDE:
        ...
        # make ct images for only liver area
        sliced_vol = data_vol[..., slide-2:slide+3] # 2.5D shape slides
        sliced_segs = data_seg[...,slide-2:slide+3].astype(bool).astype(float) # combine liver and lesion area
        sliced_ct = sliced_vol * sliced_segs
        ...
        lesion_sliced_seg[...,0] = sliced_seg[...,2]
